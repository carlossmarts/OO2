			...
			<form name="form1" method="post" action="/EdeUNLa/ModificacionLecturaADJSP ">
				<table>
					...
					<tr>
						...
						<td ><input name="nroMedidor" type="text" value="<%=lad.getMedidor().getNroSerie() %>" ></td>
					</tr>

					<tr>
						<td>fecha(dd/mm/aaaa)</td>
						<td ><input name="fecha" type="text" value="<%=lad.getFecha() %>" ></td>
					</tr>
					<tr>
						<td>Hora (hh:mm:ss)</td>
					...
					<tr>
						...
						<td ><input name="inspector" type="text" value="<%=lad.getInspector().getCuil()%>"></td>
					</tr>
					<tr>
						<td>Consumo pico</td>
						<td ><input name="pico" type="text" value="<%=lad.getConsumoPico() %>" ></td>
					</tr>
					<tr>
						<td>Consumo valle</td>
						<td ><input name="valle" type="text" value="<%=lad.getConsumoValle() %>" ></td>
					</tr>
					<tr>
						<td>Consumo resto</td>
						<td ><input name="resto" type="text" value="<%=lad.getConsumoResto()%>"></td>
					</tr>
					<tr>
